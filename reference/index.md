...
Functions for calibrating radiocarbon determinations to a calendar
timescale
...
- [`cal_mode()`](https://c14.joeroe.io/reference/cal_mode.md)
  ...
  [`cal_local_mode()`](https://c14.joeroe.io/reference/cal_mode.md)
  [`cal_central()`](https://c14.joeroe.io/reference/cal_mode.md) : Point
...
Functions for aggregating calibrated radiocarbon determinations
...
## Tidy radiocarbon metadata

Functions for tidying metadata associated with radiocarbon
determinations
